export default function(baseFontSize, psdWidth, maxWidth) {
  var _baseFontSize = baseFontSize || 100
  var _psdWidth = psdWidth || 750
  var _maxWidth = maxWidth || 1024
  ...
  metaEl.setAttribute(
    'content',
    'width=device-width,viewport-fit=cover,user-scalable=no,initial-scale=' +
      scale +
      ',maximum-scale=' +
      scale +
      ',minimum-scale=' +
  ...
  function setFontSize() {
    var max = Math.min(_maxWidth * (1 / scale), docEl.clientWidth)
    docEl.style.fontSize = _baseFontSize / _psdWidth * max * rate + 'px'
  }
  setFontSize()
